...
/**
 * Decodes and validates ID tokens issues by Auth0, the OAuth provider for hoistapp.
 */
@Slf4j
class Auth0Service extends BaseService {
    ...
    Map getClientConfig() {
        ...
        return [
            clientId: clientId,
            domain: domain
            //clientId: getInstanceConfig('auth0ClientId'),
            //domain: getInstanceConfig('auth0Domain')
        ]
    }
    ...
    JsonWebKeySet getJsonWebKeySet() {
        if (!_jkws) {
            ...
            _jkws = new JsonWebKeySet(getInstanceConfig('auth0Jwks'))
    ...
    private String getClientId() {
        ...
        return getInstanceConfig('auth0ClientId')
    }

    private String getDomain() {
        //return configService.getString('auth0Domain')
        return getInstanceConfig('auth0Domain')
    }
